...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './def-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEFTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEFTYPE actions', async () => {
      const expectedActions = [
        {
