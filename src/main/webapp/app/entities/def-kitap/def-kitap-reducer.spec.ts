...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './def-kitap.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEFKITAP_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEFKITAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEFKITAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEFKITAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEFKITAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEFKITAP actions', async () => {
      const expectedActions = [
        {
