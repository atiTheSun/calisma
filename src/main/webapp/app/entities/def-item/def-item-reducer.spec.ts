...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './def-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEFITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEFITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEFITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEFITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEFITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEFITEM actions', async () => {
      const expectedActions = [
        {
